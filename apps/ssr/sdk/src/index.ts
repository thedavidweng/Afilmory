import type { AnalysisDto, AnalysisResponse } from '../../src/app/api/aggregation/analysis/dto'
...
export class Client {
  ...
  async analysis(data: AnalysisDto) {
    return (await fetch(`${this.baseUrl}/api/aggregation/analysis?${new URLSearchParams(data).toString()}`, {
      method: 'GET',
